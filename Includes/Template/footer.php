                        ...
                        <div class="col-xl-4 col-md-12 col-lg-4">
                                <div class="footer_widget">
                                        ...
                                        <form action="#" class="newsletter_form">
                                            ...
                                            <button type="submit" style="font-family: 'East Sea Dokdo'"><a href="
                                            <?php if(isset($_SESSION['User_Type_Id']) AND  $_SESSION['User_Type_Id']== 1)
                                             { echo $adminHome; }else{echo $userHome; }  ?>">My Account</a></button>
